(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["FramePlayer"] = factory();
	else
		root["FramePlayer"] = factory();
})(this, function() {
...
var _eventemitter = __webpack_require__(96);

var _eventemitter2 = _interopRequireDefault(_eventemitter);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var FramePlayer = function (_EventEmitter) {
  (0, _inherits3.default)(FramePlayer, _EventEmitter);
  ...
  function FramePlayer() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        canvas = _ref$canvas === undefined ? 'canvas' : _ref$canvas,
        ...
        _ref$fps = _ref.fps,
        fps = _ref$fps === undefined ? 24 : _ref$fps,
        _ref$loop = _ref.loop,
        loop = _ref$loop === undefined ? 0 : _ref$loop,
        _ref$alternate = _ref.alternate,
        alternate = _ref$alternate === undefined ? false : _ref$alternate,
    ...
    (0, _classCallCheck3.default)(this, FramePlayer);

    var _this = (0, _possibleConstructorReturn3.default)(this, (FramePlayer.__proto__ || (0, _getPrototypeOf2.default)(FramePlayer)).call(this));

    if (typeof canvas === 'string') {
      canvas = document.querySelector(canvas);
    }
    _this._ctx2d = canvas.getContext('2d');
    canvas.setAttribute('width', width);
    canvas.setAttribute('height', height);
    _this._width = width;
    _this._height = height;
    _this._startFrame = 0;
    _this._endFrame = images.length - 1;
    ...
    _this._times = 0;
    _this._timestamp = 0;
    _this._autoPlay = autoPlay;
    _this._frames = _this._load(images);
    return _this;
  }

  (0, _createClass3.default)(FramePlayer, [{
    key: 'play',
    value: function play() {
    ...
    value: function _tick() {
      ...
      this._rafId = (0, _raf2.default)(function () {
        return _this3._tick();
      });
    }
  }, {
    ...
    value: function _update() {
      ...
      if ((this._currentFrame === this._endFrame || this._currentFrame === this._startFrame) && this._continue) {
        if (this._loop && (this._times + 1 < this._loop || this._loop === -1)) {
          var _sort = [this._startFrame, this._endFrame].sort(),
